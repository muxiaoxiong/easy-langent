...
| 第三章 LangChain进阶应用：链式工作流与RAG系统构建 | 智能体定义、类型、范式与应用 | 🚧    |
| 第四章 LangGraph基础：有状态工作流与核心概念实操  | 智能体定义、类型、范式与应用 | 🚧    |
| 第五章 LangGraph进阶：多智能体协作与复杂流程管控  | 智能体定义、类型、范式与应用 | 🚧    |
| 第六章 智能体构建核心要点：设计原则与优化策略     | 智能体定义、类型、范式与应用 | 🚧    |
| 第七章 综合实战：从零构建可落地的智能体系统       | 智能体定义、类型、范式与应用 | 🚧    |
